//
//  YNWriteCommentViewController.swift
//  WXT_Parents
//
...
class YNWriteCommentViewController: UIViewController,UICollectionViewDataSource,UICollectionViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.rightBarButtonItem = UIBarButtonItem(title: "发送", style: .Plain, target: self, action: #selector(YNWriteCommentViewController.sendDone))
    ...
    func createUI(){
        ...
        addPictureBtn.addTarget(self, action: #selector(YNWriteCommentViewController.AddPictrures), forControlEvents: UIControlEvents.TouchUpInside)
        //        创建流视图
