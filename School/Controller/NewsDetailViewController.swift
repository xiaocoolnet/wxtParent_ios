...
class NewsDetailViewController:UIViewController,UITableViewDelegate,UITableViewDataSource{
    ...
    func shareWC(){
        ...
        //
        if self.tag == 2 {
            let url = "http://wxt.xiaocool.net/index.php?g=portal&m=article&a=news&id=" + id
            ...
            let url = "http://wxt.xiaocool.net/index.php?g=portal&m=article&a=notice&id=" + id
            shareParames.SSDKSetupShareParamsByText(url,
                                                    images : UIImage(named: "1.png"),
                                                    url : NSURL(string:url),
                                                    title : "园所公告",
    ...
    func GETData(){
        //  需要拼接id
        if self.tag == 2 {
            let url = NSURL(string: "http://wxt.xiaocool.net/index.php?g=portal&m=article&a=news&id" + id)
