...
class CKReadAllViewController: UIViewController ,UITableViewDelegate,UITableViewDataSource{
...
//    创建表
    func createTable(){
        ...
        table.registerNib(UINib.init(nibName: "CKReadAllTableViewCell", bundle: nil), forCellReuseIdentifier: "CKReadAllCell")
    }
//    创建底部试图
...
//    单元格
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("CKReadAllCell", forIndexPath: indexPath) as! CKReadAllTableViewCell
        return cell
    }
