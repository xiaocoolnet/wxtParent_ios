//
//  HWriteCommentViewController.swift
//  WXT_Parents
//
...
class HWirteCommentViewController: UIViewController,UICollectionViewDataSource,UICollectionViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.rightBarButtonItem = UIBarButtonItem(title: "发送", style: .Plain, target: self, action: #selector(HWirteCommentViewController.sendDone))
    ...
    func createUI(){
        ...
        addPictureBtn.addTarget(self, action: #selector(HWirteCommentViewController.AddPictrures), forControlEvents: UIControlEvents.TouchUpInside)
        //        创建流视图
