...
class ReadOverViewController: UIViewController,UITableViewDelegate,UITableViewDataSource{
...
//        self.DropDownUpdate()
    ...
    //    刷新
    func DropDownUpdate(){
        self.table.headerView = XWRefreshNormalHeader(target: self, action: #selector(ReadOverViewController.loadData))
