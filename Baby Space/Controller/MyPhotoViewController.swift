...
class MyPhotoViewController: UIViewController,UITableViewDelegate,UITableViewDataSource, UITextFieldDelegate{
...
//            pingView = UIView()
        ...
        let aview = UIView()
        aview.frame = CGRectMake(0, height + image_h + 100 + view.frame.size.height + h + 2, WIDTH, 10)
