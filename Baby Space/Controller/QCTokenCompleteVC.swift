...
class QCTokenCompleteVC: UITableViewController {
        ...
        func loadData(){
            ...
            //  http://wxt.xiaocool.net/index.php?g=apps&m=student&a=gettransportconfirmation&studentid=682
        ...
        override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
            ...
            //        时间戳转换
            print(takeInfo.delivery_status)
