...
class NUnreadViewController: UIViewController,UITableViewDelegate,UITableViewDataSource{
    ...
    //    刷新
    func DropDownUpdate(){
        self.table.headerView = XWRefreshNormalHeader(target: self, action: #selector(NUnreadViewController.loadData))
...
//        注册cell
    ...
    func createAllChooseView(){
        ...
        allBtn.addTarget(self, action: #selector(NUnreadViewController.allChoose(_:)), forControlEvents: .TouchUpInside)
        ...
        remindBtn.addTarget(self, action: #selector(NUnreadViewController.remindPress), forControlEvents: .TouchUpInside)
