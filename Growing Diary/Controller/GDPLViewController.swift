...
class GDPLViewController: UIViewController,UITableViewDelegate,UITableViewDataSource, UITextFieldDelegate{
...
//    }
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        //        tableView.rowHeight = height + image_h + 100 + view.frame.size.height + h
         tableView.rowHeight =  height + image_h + view.frame.size.height + 70 + h + 20
