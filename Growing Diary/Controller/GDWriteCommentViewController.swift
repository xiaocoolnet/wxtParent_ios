//
//  GDWriteCommentViewController.swift
//  WXT_Parents
//
...
class GDWriteCommentViewController: UIViewController,UICollectionViewDataSource,UICollectionViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.rightBarButtonItem = UIBarButtonItem(title: "发送", style: .Plain, target: self, action: #selector(GDWriteCommentViewController.sendDone))
    ...
    func createUI(){
        ...
        addPictureBtn.addTarget(self, action: #selector(GDWriteCommentViewController.AddPictrures), forControlEvents: UIControlEvents.TouchUpInside)
        //        创建流视图
