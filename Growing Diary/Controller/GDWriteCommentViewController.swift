...
import Alamofire
//  写日志
class GDWriteCommentViewController: UIViewController,UICollectionViewDataSource,UICollectionViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, TZImagePickerControllerDelegate {
...
//        scrollView.backgroundColor = UIColor(red: 235/255.0, green: 235/255.0, blue: 235/255.0, alpha: 1)
    ...
    func createUI(){
        ...
        //        添加图片按钮
        addPictureBtn.frame = CGRectMake(8, 160, 60, 60)
    ...
    func addCollectionViewPicture(){
        ...
        self.collectionV = UICollectionView.init(frame: CGRectMake(0, 230, WIDTH, height), collectionViewLayout: flowl)
